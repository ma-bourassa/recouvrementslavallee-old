...
import abductionIllustration from "../images/dog-illustration.svg";
      ...
      <div class="container mx-auto px-4">
        <section class="py-8 px-4 text-center">
          <div class="max-w-auto mx-auto">
            ...
            <h2 class="mt-8 uppercase text-xl lg:text-4xl font-black">
              Désolé, cette page est introuvable.
            </h2>
            <p class="mt-6 text-xl text-gray-900">
              Vous pouvez nous en faire part en communiquant avec nous.
            </p>
            <a
              href="/"
              class="mt-8 bg-blue-500 hover:bg-blue-700 text-white py-3 px-6 rounded-lg inline-block shadow-md"
            >
              Accueil
            </a>
          </div>
