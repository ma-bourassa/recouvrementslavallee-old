  ...
  return (
    <Layout>
      ...
      <section>
        <div className="container mx-auto flex flex-col lg:flex-row px-6 py-6 lg:py-12 leading-relaxed">
          <div className="w-1/3 mx-12">
            <h4 className="text-xl lg:text-2xl font-semibold text-center mx-12">PHOTO </h4>
          </div>
          <div className="w-2/3 font-light text-justify lg:text-base mx-12">
            <h4 className="text-xl lg:text-2xl font-semibold mb-4">Nos spécialitées</h4>
