...
function Product({ title, paragraphes, photo, reverseOrder, products }) {
  return (
    <section>
      <div className="container mx-auto px-6 py-6 lg:py-12 flex flex-col lg:flex-row">
        ...
        <div className={`hidden w-1/2 lg:block lg:pr-32 ${reverseOrder && `order-last lg:order-first`}`}>
          ...
          {Object.keys(products).length > 0 && <p className="mt-6 mb-2 font-bold">Voir les produits disponibles</p>}
